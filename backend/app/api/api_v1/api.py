...
from .endpoints import auth, users, courses, videos, materials, chat, quiz, diagram, vision, doubts, let, exam_scheduler, mcp
...
api_router.include_router(exam_scheduler.router, prefix="/exam-scheduler", tags=["exam-scheduler"])
api_router.include_router(mcp.router, tags=["mcp-monitoring"])
